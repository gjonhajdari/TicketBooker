<?php
    ...
    $query = "SELECT `tid`, `event_title`, `option`, `date`, `location` FROM `ticket` WHERE `tid`='" . $_SESSION["tid"] ."' `option` = '" . $_SESSION["option"] . "' AND `date` = '" . $_SESSION["date"] . "' AND `location` = '" . $_SESSION["location"] . "' ";

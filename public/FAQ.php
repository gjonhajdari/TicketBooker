...
$(document).ready(function() {
  ...
  <div class="container">
    ...
    TicketBooker is the first ever website in Kosovo where the citizens of Kosovo can book tickets all around Kosovo, starting from traveling tickets to movies and concerts!
    </div>
